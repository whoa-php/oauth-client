...
class InvalidArgumentException extends \InvalidArgumentException implements WhoaExceptionInterface
{
    ...
    /** @var string Error key */
    public const ERROR_MISSING_PROVIDER = 'error_missing_provider';

    /** @var string Error key */
    public const ERROR_MISSING_PROVIDER_NAME = 'error_missing_provider_name';

    /** @var string Error key */
    public const ERROR_MISSING_CLIENT_ID = 'error_missing_client_id';

    /** @var string Error key */
    public const ERROR_MISSING_TENANT_ID = 'error_missing_tenant_id';

    /** @var string Error key */
    public const ERROR_MISSING_JWK_URIS = 'error_missing_jwk_uris';

    /** @var string Error key */
    public const ERROR_MISSING_JWK_SET_URI_KEY = 'error_missing_jwk_set_uri_key';

    /** @var string Error key */
    public const ERROR_MISSING_JWK = 'error_missing_jwk';

    /** @var string Error key */
    public const ERROR_MISSING_SERIALIZE_JWT = 'error_missing_serialize_jwt';

    /** @var string Error key */
    public const ERROR_INVALID_JWT_FORMAT = 'error_invalid_jwt_format';

    /** @var string Error key */
    public const ERROR_MISSING_HTTP_CLIENT = 'error_missing_http_client';

    /** @var string Error key */
    public const ERROR_INVALID_URI = 'error_invalid_uri';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_SERIALIZERS = 'error_missing_jwt_serializers';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_ALGORITHMS = 'error_missing_jwt_algorithms';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_ALGORITHM_MANAGER = 'error_missing_jwt_algorithm_manager';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_HEADER_CHECKERS = 'error_missing_jwt_header_checkers';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_TOKEN_TYPE_SUPPORTS = 'error_missing_jwt_token_type_supports';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_CLAIM_CHECKERS = 'error_missing_jwt_claim_checkers';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_SERIALIZER_MANAGER = 'error_missing_jwt_serializer_manager';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_VERIFIER = 'error_missing_jwt_verifier';

    /** @var string Error key */
    public const ERROR_MISSING_JWT_HEADER_CHECKER_MANAGER = 'error_missing_jwt_header_jwt_header_manager';

    /** @var string Error messages */
    public const DEFAULT_MESSAGES = [
        self::ERROR_INVALID_REQUEST => 'Invalid, unknown or unexpected request',
