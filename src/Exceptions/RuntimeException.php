...
class RuntimeException extends \RuntimeException implements WhoaExceptionInterface
{
    ...
    /** @var string Error key */
    public const ERROR_LOAD_DISCOVERY_DOCUMENT = 'error_load_discovery_document';

    /** @var string Error key */
    public const ERROR_PARSE_METADATA_DISCOVERY_DOCUMENT = 'error_parse_metadata_discovery_document ';

    /** @var string Error key */
    public const ERROR_UNDEFINED_JWK_SET_URI_KEY = 'error_undefined_jwk_set_uri_key ';

    /** @var string Error key */
    public const ERROR_LOAD_JWK_SET_METADATA = 'error_load_jwk_set_metadata ';

    /** @var string Error key */
    public const ERROR_LOAD_JWK_METADATA = 'error_load_jwk_metadata ';

    /** @var string Error key */
    public const ERROR_DESERIALIZE_JWT = 'error_deserialize_jwt ';

    /** @var string Error key */
    public const ERROR_VERIFY_JWT_HEADERS = 'error_verify_jwt_headers ';

    /** @var string Error key */
    public const ERROR_VERIFY_JWT_KEYS = 'error_verify_jwt_keys ';

    /** @var string Error key */
    public const ERROR_VERIFY_JWT_CLAIMS = 'error_verify_jwt_claims ';

    /** @var string Error key */
    public const ERROR_PARSE_JWT_PAYLOAD = 'error_parse_jwt_payload ';

    /** @var string Error key */
    public const ERROR_PARSE_JWK_SET = 'error_parse_jwk_set ';

    /** @var string Error key */
    public const ERROR_PARSE_JWK = 'error_parse_jwk ';
